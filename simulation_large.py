...
def simulate_env_large(strategy):
    ...
    for i in range(len(packets)):
        ...
        if strategy == "Heaps":
            ...
            server.add_packet(packet)
    run_load_plotter(servers, strategy, 'large')
    run_mean_and_stdev_plotter(servers, strategy, 'large')
    run_throughput_plotter(servers, strategy, 'large')
    run_response_time_plotter(servers,strategy, 'large')
