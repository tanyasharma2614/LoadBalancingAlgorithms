...
def simulate_env_small(strategy):
    print("Simulated environment with load balance strategy: ", strategy)
    packets = []
    ...
    for i in range(len(packets)):
        ...
        if strategy == "Heaps":
            ...
            server.add_packet(packet)
    run_load_plotter(servers, strategy, 'small')
    run_mean_and_stdev_plotter(servers, strategy, 'small')
    run_throughput_plotter(servers, strategy, 'small')
    run_response_time_plotter(servers,strategy, 'small')
