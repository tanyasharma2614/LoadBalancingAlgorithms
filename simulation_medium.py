...
def simulate_env_medium(strategy):
    print("Simulated MEDIUM environment with load balance strategy: ", strategy)
    packets = []
    ...
    for i in range(len(packets)):
        ...
        if strategy == "Heaps":
            ...
            server.add_packet(packet)
    run_load_plotter(servers, strategy, 'medium')
    run_mean_and_stdev_plotter(servers, strategy, 'medium')
    run_throughput_plotter(servers, strategy, 'medium')
    run_response_time_plotter(servers,strategy, 'medium')
